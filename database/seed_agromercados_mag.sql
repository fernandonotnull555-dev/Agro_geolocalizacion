-- Datos oficiales referencia: AgroMercados del MAG (precios justos), ~50 puntos a nivel nacional.
-- Coordenadas aproximadas (centroide municipal / lugar público) para visualización en mapa.
-- Formato MySQL: POINT(longitud latitud)
